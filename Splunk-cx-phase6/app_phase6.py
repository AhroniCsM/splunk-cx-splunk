...
logger = logging.getLogger("MyApp-Phase6-TCP")
...
if __name__ == "__main__":
    logger.info("=" * 80)
    logger.info("PHASE 6 APPLICATION STARTED - EXPERIMENTAL TCP")
    logger.info("=" * 80)
    logger.info(f"Writing logs to: {LOG_FILE}")
    logger.info(f"Log interval: {LOG_INTERVAL_SECONDS} seconds")
    logger.info("Splunk Universal Forwarder will send via TCP to OTEL tcplog receiver")
    logger.info("Testing if tcplog receiver can handle Splunk TCP protocol...")
    logger.info("=" * 80)
